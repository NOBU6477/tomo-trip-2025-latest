...
function initializeGuideData() {
  ...
  const guideData = {
    ...
    fee: 20000,
    keywords: ["写真スポット", "観光"],
    imageUrl: "https://via.placeholder.com/400x300?text=%E5%9F%BC%E7%8E%89%E7%9C%8Cガイド",
  ...
  try {
    ...
    if (!hasHokkaidoGuide) {
      ...
      const hokkaidoGuideData = {
        ...
        fee: 8000,
        keywords: ["自然", "雪景色", "温泉"],
        imageUrl: "https://via.placeholder.com/400x300?text=%E5%8C%97%E6%B5%B7%E9%81%93ガイド",
