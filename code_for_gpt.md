# Local Guide プロジェクト - index.html 全コード

## ファイル情報
- ファイル名: index.html
- 行数: 3736行
- 機能: メインホームページ（ガイド一覧、検索・フィルター、多言語対応）

## 使用方法
このファイルの内容をコピーして他のGPTに分析・改善提案を依頼できます。
...
<html lang="ja">
  <head>
    ...
    <style>
      ...
      .sponsor-swiper .swiper-button-next:hover,
      .sponsor-swiper .swiper-button-prev:hover {
        background: white;
  ...
  <body>
            ...
            <div class="dropdown d-inline-block">
              ...
              >
                ...
                <li>
                  <a
                    class="dropdown-item d-flex align-items-center"
                    href="guide-registration-form.html"
                    id="direct-guide-register-link"
                  >
    ...
    <section class="bg-white py-4">
      <div class="container">
        ...
        <div class="swiper sponsor-swiper position-relative">
        ...
        <div class="mb-4">
          ...
          <div class="text-center mb-3">
            <button type="button" class="btn btn-outline-primary" id="toggle-filter-button">
              <i class="bi bi-funnel"></i> 詳細検索フィルター
            </button>
          </div>
        ...
        <div class="container">
          ...
          <div class="text-center mt-4">
            <button
              ...
              onclick="window.location.href='bootstrap_solution.html'"
            >
              ガイドとして登録する
            </button>
          </div>
    ...
    <script>
      function translateGuideCards() {
        ...
        console.log('翻訳関数実行, 言語:', lang);
        
        if (lang !== 'en') return;

        // ガイドカードの説明文を翻訳（より広範囲のセレクタ）
        document.querySelectorAll('.card p, .guide-card p, .card-text, [class*="description"], [class*="desc"]').forEach(desc => {
          const text = desc.textContent.trim();
          console.log('処理中のテキスト:', text);
          
          // 地域名のみの場合はスキップ
          if (text.length < 10 || text.match(/^[都道府県市町村\s]+$/)) {
            return;
          }
          ...
          if (text.includes('Tokyo') && text.includes('隠れた名所')) {
            ...
            console.log('北海道ガイド翻訳完了');
          } else if (text.includes('北海道・札幌のローカルガイド')) {
            desc.textContent = 'Hokkaido local guide specializing in Sapporo. We will guide you to photography spots and sightseeing spots throughout the four seasons.';
            console.log('北海道札幌ガイド翻訳完了');
          } else if (text.includes('魅力を知り尽くしたローカルガイドです')) {
            desc.textContent = 'Local guide who knows all the charm. We will guide you to photography spots and sightseeing spots.';
            console.log('ローカルガイド翻訳完了');
          } else if (text.includes('高知県在住10年以上のガイドが')) {
            desc.textContent = 'Guide with over 10 years of residence in Kochi Prefecture will guide you to activity and nature spots that tourists alone cannot find.';
            console.log('高知ガイド翻訳完了');
            ...
            console.log('福岡ガイド翻訳完了');
          } else if (text.includes('生まれも育ちも') && text.includes('の地元っ子')) {
            desc.textContent = 'Born and raised local resident. We propose plans tailored to your interests including hot springs and relaxation.';
            console.log('地元っ子ガイド翻訳完了');
          } else if (text.includes('の歴史と文化に精通したガイドです')) {
            desc.textContent = 'Guide well-versed in local history and culture. We will guide you through a wide range from music to entertainment.';
            console.log('歴史文化ガイド翻訳完了');
          } else if (text.includes('で育った地元民ならではの視点で') && text.includes('を案内します')) {
            desc.textContent = 'From the perspective of a local who grew up here, we will guide you to shopping spots and fashion areas.';
            console.log('地元民視点ガイド翻訳完了');
          } else if (text.includes('の自然や文化を愛する地元ガイド')) {
            desc.textContent = 'Local guide who loves the nature and culture of the area. We especially share local charm and can also guide you to traditional spots.';
            console.log('自然文化ガイド翻訳完了');
          } else if (text.includes('出身のガイドが地元の隠れた名所をご紹介')) {
            desc.textContent = 'Local guide will introduce hidden spots. Especially rich in activity and craft spots.';
            console.log('隠れた名所ガイド翻訳完了');
          } else if (text.includes('在住10年以上のガイドが、観光客だけでは見つけられない') && text.includes('にご案内します')) {
            desc.textContent = 'Guide with over 10 years of residence will guide you to places that tourists alone cannot find.';
            console.log('在住ガイド翻訳完了');
          } else if (text.includes('秋田県在住10年以上のガイドが、観光客だけでは見つけられない温泉やリラクゼーションの場所にご案内します')) {
            desc.textContent = 'Guide with over 10 years of residence in Akita Prefecture will guide you to hot spring and relaxation places that tourists alone cannot find.';
            console.log('秋田在住ガイド翻訳完了');
          } else if (text.includes('沖縄県のローカルフードやトレンドスポットを知り尽くしています。アクティビティ好きの方におすすめです')) {
            desc.textContent = 'We know all about Okinawa Prefecture local food and trendy spots. Recommended for those who like activities.';
            console.log('沖縄ローカルフードガイド翻訳完了');
          } else if (text.includes('生まれも育ちも北海道の地元っ子。建築や街歩きなど、あなたの興味に合わせたプランをご提案します')) {
            desc.textContent = 'Born and raised in Hokkaido, a local resident. We propose plans tailored to your interests, including architecture and city walks.';
            console.log('北海道地元っ子ガイド翻訳完了');
          } else if (text.includes('生まれも育ちも奈良県の地元っ子。工芸品やお土産など、あなたの興味に合わせたプランをご提案します')) {
            desc.textContent = 'Born and raised in Nara Prefecture, a local resident. We propose plans tailored to your interests, including crafts and souvenirs.';
            console.log('奈良地元っ子ガイド翻訳完了');
          } else if (text.includes('東京都在住10年以上のガイドが、観光客だけでは見つけられない温泉やリラクゼーションの場所にご案内します')) {
            desc.textContent = 'Guide with over 10 years of residence in Tokyo will guide you to hot spring and relaxation places that tourists alone cannot find.';
            console.log('東京在住ガイド翻訳完了');
          } else if (text.includes('徳島県の自然や文化を愛する地元ガイド。特に伝統文化の魅力をお伝えします。祭りにもご案内可能です')) {
            desc.textContent = 'Local guide who loves the nature and culture of Tokushima Prefecture. We especially share the charm of traditional culture and can also guide you to festivals.';
            console.log('徳島自然文化ガイド翻訳完了');
          } else if (text.includes('沖縄県の歴史と文化に精通したガイドです。工芸品からお土産まで幅広くご案内します')) {
            desc.textContent = 'Guide well-versed in Okinawa Prefecture history and culture. We will guide you through a wide range from crafts to souvenirs.';
            console.log('沖縄歴史文化ガイド翻訳完了');
          } else if (text.includes('新潟県出身のガイドが地元の隠れた名所をご紹介。特に建築スポットが充実しています')) {
            desc.textContent = 'Guide from Niigata Prefecture will introduce local hidden spots. Especially rich in architectural spots.';
            console.log('新潟隠れた名所ガイド翻訳完了');
          } else if (text.includes('東京都の歴史と文化に精通したガイドです。写真スポットから観光まで幅広くご案内します')) {
            desc.textContent = 'Guide well-versed in Tokyo history and culture. We will guide you through a wide range from photography spots to sightseeing.';
            console.log('東京歴史文化ガイド翻訳完了');
          } else if (text.includes('長崎県出身のガイドが地元の隠れた名所をご紹介。特にアクティビティスポットが充実しています')) {
            desc.textContent = 'Guide from Nagasaki Prefecture will introduce local hidden spots. Especially rich in activity spots.';
            console.log('長崎隠れた名所ガイド翻訳完了');
          } else if (text.includes('特化したツアーを提供しています') || text.includes('特化したツアーを提供して')) {
            if (text.includes('建築')) {
              desc.textContent = 'We provide tours specializing in architecture. You can also enjoy city walks.';
              console.log('建築特化ツアー翻訳完了');
            } else if (text.includes('アクティビティ')) {
              desc.textContent = 'We provide tours specializing in activities. You can also enjoy nature.';
              console.log('アクティビティ特化ツアー翻訳完了');
            } else if (text.includes('歴史')) {
              desc.textContent = 'We provide tours specializing in history. You can also enjoy temples.';
              console.log('歴史特化ツアー翻訳完了');
            } else if (text.includes('ショッピング')) {
              desc.textContent = 'We provide tours specializing in shopping. You can also enjoy fashion.';
              console.log('ショッピング特化ツアー翻訳完了');
            } else if (text.includes('ナイトツアー')) {
              desc.textContent = 'We provide tours specializing in night tours. You can also enjoy gourmet food.';
              console.log('ナイトツアー特化翻訳完了');
            } else if (text.includes('登山')) {
              desc.textContent = 'We provide tours specializing in mountain climbing. You can also enjoy trekking.';
              console.log('登山特化ツアー翻訳完了');
            } else if (text.includes('マリンスポーツ')) {
              desc.textContent = 'We provide tours specializing in marine sports. You can also enjoy beaches.';
              console.log('マリンスポーツ特化ツアー翻訳完了');
            } else if (text.includes('工芸品')) {
              desc.textContent = 'We provide tours specializing in crafts. You can also enjoy souvenirs.';
              console.log('工芸品特化ツアー翻訳完了');
            } else {
              desc.textContent = 'We provide specialized tours. You can enjoy various experiences.';
              console.log('その他特化ツアー翻訳完了:', text.substring(0, 30) + '...');
            }
          } else if (text.includes('沖縄県のアクティビティに特化したツアーを提供しています。自然も併せてお楽しみいただけます')) {
            desc.textContent = 'We provide tours specializing in Okinawa activities. You can also enjoy nature.';
            console.log('沖縄アクティビティ特化ツアー翻訳完了');
          } else if (text.includes('富山県のマリンスポーツに特化したツアーを提供しています。ビーチも併せてお楽しみいただけます')) {
            desc.textContent = 'We provide tours specializing in Toyama marine sports. You can also enjoy beaches.';
            console.log('富山マリンスポーツ特化ツアー翻訳完了');
          } else if (text.includes('新潟県のショッピングに特化したツアーを提供しています。ファッションも併せてお楽しみいただけます')) {
            desc.textContent = 'We provide tours specializing in Niigata shopping. You can also enjoy fashion.';
            console.log('新潟ショッピング特化ツアー翻訳完了');
          } else if (text.includes('沖縄県の歴史に特化したツアーを提供しています。寺院も併せてお楽しみいただけます')) {
            desc.textContent = 'We provide tours specializing in Okinawa history. You can also enjoy temples.';
            console.log('沖縄歴史特化ツアー翻訳完了');
          } else if (text.includes('Photo Spotsと観光を中心に') && text.includes('の魅力をお伝えします')) {
            desc.textContent = 'Focusing on photo spots and sightseeing, we will share the charm of the area. You can also experience local life and culture.';
            console.log('Photo Spots観光ガイド翻訳完了');
          } else if (text.includes('アクティビティと自然を中心に') && text.includes('の魅力をお伝えします')) {
            desc.textContent = 'Focusing on activities and nature, we will share the charm of the area. You can also experience local life and culture.';
            console.log('アクティビティ自然ガイド翻訳完了');
          } else if (text.includes('のローカルフードやトレンドスポットを知り尽くしています')) {
            desc.textContent = 'We know all about local food and trendy spots. Recommended for those who like sake brewery tours.';
            console.log('ローカルフードガイド翻訳完了');
          } else if (text.includes('アクティビティと自然を中心に、東京都の魅力をお伝えします')) {
            desc.textContent = 'Focusing on activities and nature, we will share the charm of Tokyo. You can also experience local life and culture.';
            console.log('東京アクティビティガイド翻訳完了');
          } else if (text.includes('千葉県の歴史に特化したツアーを提供しています')) {
            desc.textContent = 'We provide tours specializing in Chiba Prefecture history. You can also enjoy temples.';
            console.log('千葉歴史ガイド翻訳完了');
          } else if (text.includes('鳥取県のローカルガイドやトレンドスポットを知り尽くしています')) {
            desc.textContent = 'We know all about Tottori Prefecture local guides and trendy spots. Recommended for those who like shopping.';
            console.log('鳥取ガイド翻訳完了');
          } else {
            // 強制翻訳：日本語を含むすべてのテキストを翻訳（最後の手段）
            if (text.match(/[\u3040-\u309F\u30A0-\u30FF\u4E00-\u9FAF]/)) {
              // 日本語文字が含まれている場合、強制的に翻訳
              if (text.includes('特化したツアー') || text.includes('ツアーを提供')) {
                desc.textContent = 'We provide specialized tours. You can enjoy various experiences.';
                console.log('強制特化ツアー翻訳完了:', text.substring(0, 30) + '...');
              } else if (text.includes('Photo Spots') || text.includes('観光を中心に')) {
                desc.textContent = 'Focusing on photo spots and sightseeing, we will share the charm of the area. You can also experience local life and culture.';
                console.log('強制Photo Spots翻訳完了');
              } else if (text.includes('ガイド') || text.includes('案内') || text.includes('ご紹介') || text.includes('プラン')) {
                desc.textContent = 'Local guide who will introduce you to the charm of the area. We provide various tour experiences tailored to your interests.';
                console.log('強制ガイド翻訳完了:', text.substring(0, 30) + '...');
              } else {
                desc.textContent = 'Professional local guide. We provide unique tour experiences.';
                console.log('強制一般翻訳完了:', text.substring(0, 30) + '...');
              }
            }
          }
        });
      ...
      // 強制的に翻訳を実行する関数
      function forceTranslateGuides() {
        console.log('強制翻訳実行');
        const lang = localStorage.getItem('selectedLanguage') || 'ja';
        console.log('現在の言語設定:', lang);
      ...
      // 初回実行
      document.addEventListener('DOMContentLoaded', function() {
        console.log('DOM読み込み完了、翻訳実行');
        setTimeout(forceTranslateGuides, 500);
      });
      ...
      document.addEventListener('click', function(e) {
        if (e.target.closest('[data-lang]')) {
          ...
          setTimeout(forceTranslateGuides, 200);
        }
      });
    ...
    <!-- JavaScriptコードを一時的に無効化してデバッグ情報の表示を停止 -->
    <!-- <script>
          // 地域名の翻訳コードは一時的に無効化
    </script> -->
        ...
        // 混在翻訳を修正する関数
        function fixMixedTranslation(text) {
          // 日英混在パターンを完全な英語に修正
        ...
        function translateGuideCards() {
          ...
          if (lang === 'en') {
            ...
            document.querySelectorAll('.guide-card, .card').forEach(card => {
              // ガイド名や地域情報は維持し、説明文のみ翻訳
              const descriptionElements = card.querySelectorAll('p, .description, .guide-description');
              descriptionElements.forEach(desc => {
                let text = desc.textContent;
                let originalText = text;
                
                console.log('翻訳対象テキスト:', originalText);
                
                // 説明文の翻訳（様々なパターンに対応）
                  'I guide you to Tokyo\'s hidden gems. I specialize in gourmet spots and photo locations.');
                  'I guide you to Tokyo\'s hidden gems. I specialize in gourmet spots and photo locations.');
                  
                // より包括的なパターンマッチング
                if (text.includes('Tokyo') && text.includes('隠れた名所')) {
                  text = 'I guide you to Tokyo\'s hidden gems. I specialize in gourmet spots and photo locations.';
                } else if (text.includes('東京') && text.includes('隠れた名所')) {
                  text = 'I guide you to Tokyo\'s hidden gems. I specialize in gourmet spots and photo locations.';
                }
                
                  'Guiding you through Kyoto\'s charm with its breathing history and tradition. I specialize in temple visits and traditional cultural experiences.');
                  'Guiding you through Kyoto\'s charm with its breathing history and tradition. I specialize in temple visits and traditional cultural experiences.');
                  'Specializing in Osaka\'s unique food tours and city walks. I\'ll guide you to famous restaurants known only to locals.');
                  'Specializing in Osaka\'s unique food tours and city walks. I\'ll guide you to famous restaurants known only to locals.');
                  'Proposing tours to enjoy Hokkaido\'s great nature and gourmet food. I\'ll share the charm of each season.');
                  'Experience Okinawa\'s beautiful sea and unique culture. From marine sports to historical walks, I offer a wide range of activities.');
                  'Specializing in tours visiting Hiroshima\'s Peace Memorial Park, Miyajima, and other historical and natural sites. I provide memorable experiences.');
                
                // 動的ガイドの説明文翻訳
                  'Local guide in Sapporo, Hokkaido. I\'ll share the charm of Shirayuki Park. I can also guide you on trekking.');
                  'Diving instructor with 15 years of experience in Okinawa. I\'ll guide you through beautiful seas and unique culture.');
                  'Guide well-versed in Hiroshima history and culture. Specializing in tours visiting Peace Memorial Park, Miyajima, and other historical and natural sites.');
                
                // より一般的なパターンマッチング
                if (text.includes('北海道') && text.includes('ローカルガイド')) {
                  text = 'Local guide in Sapporo, Hokkaido. I\'ll share the charm of Shirayuki Park. I can also guide you on trekking.';
                } else if (text.includes('沖縄県') && text.includes('ダイビング')) {
                  text = 'Diving instructor with 15 years of experience in Okinawa. I\'ll guide you through beautiful seas and unique culture.';
                } else if (text.includes('Hiroshima') && text.includes('History')) {
                  text = 'Guide well-versed in Hiroshima history and culture. Specializing in tours visiting Peace Memorial Park, Miyajima, and other historical and natural sites.';
                }
                
                // 混在翻訳をクリーンアップしてから処理
                if (text.includes('Born and raised in') || text.includes('guide with over 10 years') || text.includes('is a local guide')) {
                  // 混在状態を修正
                  text = fixMixedTranslation(text);
                } else if (originalText !== text) {
                  // 既に翻訳済みの場合はそのまま
                } else if (text.match(/[\u3040-\u309F\u30A0-\u30FF\u4E00-\u9FAF]/)) {
                  // 日本語文字が含まれている場合の汎用翻訳
                  text = translateGuideDescription(text);
                }
                
                // その他の一般的な翻訳
                
                if (text !== originalText) {
                  console.log('ガイドカード翻訳実行:', originalText, '->', text);
                  desc.textContent = text;
                } else {
                  console.log('翻訳対象外または既に翻訳済み:', originalText);
                }
              });
              ...
              buttons.forEach(btn => {
                if (btn.textContent.trim() === 'See Details') {
                  // 既に英語の場合はそのまま
                  return;
                } else if (btn.textContent.includes('詳細を見る') || btn.textContent.includes('詳細')) {
                  btn.textContent = 'See Details';
                  console.log('ボタン翻訳:', btn.textContent);
                }
              });
            });
          }
        ...
        setTimeout(translateGuideCards, 500);
        setTimeout(translateGuideCards, 1000);
    ...
    <!-- 統一検索フィルターシステム（最優先読み込み） -->
    <script src="unified-search-filter.js"></script>
    
    <!-- 緊急ページ修正スクリプト - 一時無効 -->
    <!-- <script src="emergency-page-fix.js"></script> -->
    
    <!-- ガイドカード強制表示スクリプト -->
    <script src="guide-card-force-display.js"></script>
    ...
    <!-- ガイド一覧統合システム -->
    <script src="guide-list-integration.js"></script>

    <!-- ガイドアクセス修正 -->
    <script src="guide-access-fix.js"></script>

    <!-- ガイド登録機能修正 -->
    <script src="guide-registration-fix.js"></script>

    <!-- 開発モード修正 -->
    <script src="development-mode-fix.js"></script>

    <!-- 検索フィルター修正 (統一システムにより無効化) -->
    <!-- <script src="search-filter-fix.js"></script> -->
    ...
    <script>
      ...
      function renderSponsors() {
        ...
        sponsors.forEach(store => {
          ...
          slide.style.width = "300px"; // 固定幅を設定
          slide.innerHTML = `
      ...
      // グローバル変数
      let sponsorSwiper = null;
      let lastSponsorCount = 0;

      // 下書き状態の協賛店を公開状態に修正
      function fixDraftSponsors() {
        const sponsorData = JSON.parse(localStorage.getItem('sponsorData')) || [];
        let hasChanges = false;
        
        sponsorData.forEach(store => {
          if (store.status !== 'active') {
            console.log(`協賛店「${store.name}」を公開状態に変更`);
            store.status = 'active';
            hasChanges = true;
          }
        });
        ...
        if (hasChanges) {
          ...
          console.log('協賛店データを更新しました');
        }
      }

      // データ変更が必要かチェックして更新
      function updateSponsorsIfNeeded() {
        const currentSponsors = loadSponsors();
        if (currentSponsors.length !== lastSponsorCount) {
          console.log('協賛店数に変更があったため更新します');
          renderSponsors();
          lastSponsorCount = currentSponsors.length;
        }
      }

      // 協賛店データを動的に読み込む関数
      function loadSponsors() {
        console.log('協賛店データを読み込み中...');
        
        // LocalStorageから公開済みの協賛店データを取得
        const sponsorData = JSON.parse(localStorage.getItem('sponsorData')) || [];
        console.log('登録済み協賛店データ:', sponsorData);
        
        // 公開中の協賛店のみを取得
        const activeSponsors = sponsorData.filter(sponsor => sponsor.status === 'active');
        console.log('公開中の協賛店:', activeSponsors);
        ...
        const registeredSponsors = activeSponsors.map(sponsor => ({
          ...
          category: sponsor.category || 'その他',
          location: sponsor.address || '',
          isRegistered: true
        }));
        
        // デフォルトデータ（登録済みIDと重複しないもののみ）
        const defaultSponsors = [
          { id: 1, name: "◯◯温泉旅館", benefit: "宿泊10%オフ", logo: "https://placehold.co/100x100/e3f2fd/1976d2/png?text=Logo1", isRegistered: false },
          { id: 3, name: "お土産屋", benefit: "5%割引", logo: "https://placehold.co/100x100/e3f2fd/1976d2/png?text=Logo3", isRegistered: false },
          { id: 4, name: "カフェ◯◯", benefit: "デザート無料", logo: "https://placehold.co/100x100/e3f2fd/1976d2/png?text=Logo4", isRegistered: false },
          { id: 5, name: "観光案内所", benefit: "地図無料配布", logo: "https://placehold.co/100x100/e3f2fd/1976d2/png?text=Logo5", isRegistered: false }
        ];
        
        // 登録済みのIDを取得
        const registeredIds = registeredSponsors.map(s => s.id);
        console.log('登録済みID:', registeredIds);
        
        // デフォルトデータから重複IDを除外
        const availableDefaultSponsors = defaultSponsors.filter(defaultSponsor => 
          !registeredIds.includes(defaultSponsor.id)
        );
        
        // 登録済みデータを優先して統合
        sponsors = [...registeredSponsors, ...availableDefaultSponsors];
        console.log('最終的な協賛店リスト:', sponsors);
      ...
      function updatePublicSponsors(sponsorData) {
        try {
          ...
          // Swiperが存在する場合は再初期化
          if (window.sponsorSwiper) {
            window.sponsorSwiper.update();
          }
      ...
      document.addEventListener('DOMContentLoaded', function() {
        ...
        // 定期更新を完全に停止（スライダーテストのため）
        // setInterval(() => {
        //   console.log('定期的なデータ更新実行');
        //   updateSponsorsIfNeeded();
        // }, 30000);

        // スライドが十分にあることを確認してからSwiper初期化
        let swiper;
        ...
        function initializeSwiper() {
          ...
          // まずスライドが存在することを確認
          const slideCount = document.querySelectorAll('.sponsor-swiper .swiper-slide').length;
          console.log('現在のスライド数:', slideCount);
          
          if (slideCount === 0) {
            console.log('スライドが存在しません。Swiper初期化を中止');
            return;
          }
          
          // ループ用に必要な最小スライド数を確保
          const wrapper = document.getElementById('sponsor-slider-wrapper');
          const existingSlides = Array.from(wrapper.children);
          
          if (slideCount > 0 && slideCount < 4) {
            console.log('ループのために十分なスライドを複製中...');
            // 元のスライドを数回複製してスムーズなループを確保
            const targetSlides = 6; // 6つのスライドを目標にする
            const duplicateCount = targetSlides - slideCount;
            
            for (let i = 0; i < duplicateCount; i++) {
              const originalSlide = existingSlides[i % existingSlides.length];
              const clonedSlide = originalSlide.cloneNode(true);
              // 複製されたスライドに識別用クラスを追加
              clonedSlide.classList.add('swiper-slide-duplicate-manual');
              wrapper.appendChild(clonedSlide);
            }
            console.log('複製完了、最終スライド数:', wrapper.children.length);
          }
          
          // 少し待ってからSwiper初期化
          setTimeout(() => {
            swiper = new Swiper('.sponsor-swiper', {
              slidesPerView: 'auto',
              spaceBetween: 20,
              centeredSlides: true,
              allowTouchMove: true,
              ...
              on: {
                init: function() {
                  console.log('Swiper初期化完了、スライド数:', this.slides.length);
                  console.log('自動再生設定:', this.autoplay);
                  // 1秒後に自動再生を開始
                  setTimeout(() => {
                    this.autoplay.start();
                ...
                slideChange: function() {
                  console.log('スライド変更 - 現在位置:', this.realIndex);
                  // 自動再生が停止していないか確認
                  if (!this.autoplay.running) {
                    console.log('自動再生が停止しているため再開します');
                    this.autoplay.start();
                  }
                },
                autoplayStart: function() {
                  console.log('自動再生が正式に開始されました');
                },
                autoplayStop: function() {
                  console.log('自動再生が停止されました - 理由調査中');
                },
                touchStart: function() {
                  console.log('タッチ開始 - 自動再生一時停止');
                },
                touchEnd: function() {
                  console.log('タッチ終了 - 自動再生再開');
                  setTimeout(() => {
                    this.autoplay.start();
                  }, 100);
                },
            ...
            setTimeout(() => {
              ...
              if (nextBtn) {
                console.log('右矢印ボタンが見つかりました');
                nextBtn.addEventListener('click', function() {
                  console.log('右矢印ボタンの直接クリックイベント');
                  if (swiper) {
                    swiper.slideNext();
                  }
                });
              } else {
                console.log('右矢印ボタンが見つかりません');
              }
              
              if (prevBtn) {
                console.log('左矢印ボタンが見つかりました');
                prevBtn.addEventListener('click', function() {
                  console.log('左矢印ボタンの直接クリックイベント');
                  if (swiper) {
                    swiper.slidePrev();
                  }
                });
              } else {
                console.log('左矢印ボタンが見つかりません');
              }
            }, 500);
          }, 200);
        }
        
        // データを読み込んでからスライダーを初期化
        ...
        // 定期更新を一時的に停止してスライダーの自動再生をテスト
        // setInterval(() => {
        //   const currentSponsors = loadSponsors();
        //   if (currentSponsors.length !== sponsors.length) {
      ...
      document.getElementById('sponsorRegisterForm').addEventListener('submit', function(e) {
        ...
        // 新しいストアIDを生成
        const sponsorData = JSON.parse(localStorage.getItem('sponsorData')) || [];
        console.log('新規登録: 既存の協賛店データ:', sponsorData);
        const newStoreId = sponsorData.length > 0 ? Math.max(...sponsorData.map(s => s.id)) + 1 : 1;
        console.log('新規登録: 生成された店舗ID:', newStoreId);
        ...
        localStorage.setItem('sponsorData', JSON.stringify(sponsorData));
        console.log('新規登録: 店舗データ保存完了:', newStore);
        console.log('新規登録: 更新後の全協賛店データ:', sponsorData);
        
        // 個別の店舗データも保存
        const storeKey = `sponsor_${newStoreId}`;
        localStorage.setItem(storeKey, JSON.stringify(newStore));
        console.log('新規登録: 個別データ保存完了:', storeKey);
        
        // 公開用データも即座に更新
        updatePublicSponsors(sponsorData);
        console.log('新規登録: 公開データ更新完了');
