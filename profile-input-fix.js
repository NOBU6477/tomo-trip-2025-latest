    ...
    <div class="guide-preview">
      ...
      <div class="guide-preview-footer d-flex justify-content-between align-items-center">
        ...
        <div class="guide-preview-tags">
          <span class="badge bg-primary me-1">観光</span>
          <span class="badge bg-primary me-1">食べ歩き</span>
          <span class="badge bg-primary me-1">アート</span>
        </div>
      </div>
    </div>
  `;
  ...
  if (tagsList.length === 0) {
    ...
    if (selectedTags.length > 0) {
      ...
      if (interestSection) {
        ...
        const selectedKeywords = interestSection.querySelectorAll('.badge, .tag, .keyword, .selected-keyword, .interest-item');
    ...
    customTags.forEach(tag => {
      ...
      const tagText = tag.childNodes[0].nodeValue || tag.textContent.trim();
